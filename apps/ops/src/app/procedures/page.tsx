      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">All SOPs across all workspaces</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <p className="text-sm text-muted-foreground">No procedures found. Seed some via the API.</p>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-muted/50">
                  ...
                  <th className="px-4 py-3 text-left font-medium">Executions</th>
              ...
              <tbody>
                {procedures.map((p) => (
                  <tr key={p.id} className="border-b">
                    ...
                    <td className="px-4 py-3"><Badge variant="secondary">{p.maturity}</Badge></td>
                    <td className="px-4 py-3">{p._count?.executions ?? p.executionCount}</td>
