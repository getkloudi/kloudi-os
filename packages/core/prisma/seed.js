...
\`\`\``,
    ...
    parameters: {
      name: { type: 'string', required: true, description: 'Component name in PascalCase' },
      path: { type: 'string', required: false, description: 'Target directory' },
      withTests: { type: 'boolean', default: true, description: 'Generate test file' },
      withStyles: { type: 'boolean', default: false, description: 'Generate CSS module' },
    },
    constraints: {},
    workspaceId: WORKSPACE_ID,
  },
...
5. Add mocks for external dependencies`,
    ...
    parameters: {
      target: { type: 'string', required: true, description: 'Path to file to test' },
      framework: { type: 'string', default: 'jest', description: 'Testing framework' },
      coverage: { type: 'number', default: 80, description: 'Target coverage percentage' },
    },
    constraints: {},
    workspaceId: WORKSPACE_ID,
  },
...
5. API documentation`,
    ...
    parameters: {
      resource: { type: 'string', required: true, description: 'Resource name' },
      methods: { type: 'array', default: ['GET', 'POST', 'PUT', 'DELETE'], description: 'HTTP methods' },
      auth: { type: 'boolean', default: true, description: 'Require authentication' },
    },
    constraints: {},
    workspaceId: WORKSPACE_ID,
  },
